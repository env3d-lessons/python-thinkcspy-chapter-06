...
# Early exit if running under pytest or explicitly disabled
# Check if we should skip headless recording (e.g., under pytest or opt-out)
...
SKIP_RECORDING = (
    ...
    or os.getenv("DISABLE_TURTLE_RECORDING") == "1"
)

if SKIP_RECORDING:
    from unittest.mock import MagicMock

    # Define mock replacements
    Screen = MagicMock(name="Screen")
    Turtle = MagicMock(name="Turtle")
